...
Clone down this repo either into Cloud Shell or onto your local machine

Change into the diabetes_demo folder

Open and examine the `activate.sh`

. activate.sh

Open and examine setup_bq.sh. This pulls the diabetes dataset and loads it into BigQuery

. 1_setup_bq.sh

Take a few momements to explore the diabetes_raw table
...
Use the 2 below queries to explore the model
...
Run a simple prediction using SQL
...
Things to note:
- The ADK BQ and Google Search tool setups
- The search agent
- The root agen
